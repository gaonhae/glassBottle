...
const uiErrorMessages = {
  "auth-invalid-input": "입력한 정보 형식이 올바르지 않습니다.",
  "auth-signup-invalid-input": "회원가입 정보를 다시 확인해 주세요.",
  "auth-invalid-credentials": "이메일 또는 비밀번호가 맞지 않습니다.",
  ...
  "onboarding-invalid-create-input": "가족 정보를 다시 확인해 주세요.",
  "onboarding-invalid-join-input": "참여 정보를 다시 확인해 주세요.",
  ...
  "letter-invalid-update-input": "수정할 편지 내용을 다시 확인해 주세요.",
  "letter-update-window-expired": "편지를 수정할 수 있는 시간이 지났습니다.",
  "letter-invalid-cancel-input": "취소할 편지 정보를 확인해 주세요.",
  ...
  "data-duplicate-value": "이미 같은 값이 존재합니다.",
  "unexpected-error": "문제가 발생했어요. 잠시 후 다시 시도해 주세요."
} as const;
