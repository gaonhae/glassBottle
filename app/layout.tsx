      ...
      <body>
        <div className="relative flex min-h-[100dvh] justify-center sm:px-6 sm:py-6">
          ...
          <div className="relative w-full max-w-[430px]">
            <div className="relative flex min-h-[100dvh] flex-col bg-white/72 backdrop-blur-xl sm:min-h-[calc(100dvh-3rem)] sm:overflow-hidden sm:rounded-[32px] sm:border sm:border-white/70 sm:shadow-shell">
