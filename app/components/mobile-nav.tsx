...
export function MobileNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-1/2 z-30 grid w-full max-w-[430px] -translate-x-1/2 grid-cols-4 gap-2 border-t border-white/85 bg-white/88 px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-20px_44px_-34px_rgba(15,23,42,0.55)] backdrop-blur-xl"
    >
      {navItems.map((item) => {
